    ...
    private val documentReferences =
        mutableListOf(
            ...
            DocumentReference(
                ...
                author =
                    listOf(
                        Reference(reference = FhirString(value = "Practitioner/practitioner-002"))
                    ),
                content =
                    listOf(
                        DocumentReference.Content(
                ...
                context =
                    DocumentReference.Context(
                        encounter =
                            listOf(
                                Reference(reference = FhirString(value = "Encounter/encounter-002"))
                            )
                    ),
            ),
            DocumentReference(
                ...
                context =
                    DocumentReference.Context(
                        encounter =
                            listOf(
                                Reference(reference = FhirString(value = "Encounter/encounter-003"))
                            )
                    ),
            ),
        )
