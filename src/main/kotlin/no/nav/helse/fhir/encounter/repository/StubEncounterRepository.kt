        ...
        mutableListOf(
            Encounter(
                                ...
                                Reference(
                                    reference =
                                        com.google.fhir.model.r4.String(
                                            value = "Practitioner/practitioner-001"
                                        )
                                )
                        )
                    ),
                ...
                serviceProvider =
                    Reference(
                        reference =
                            com.google.fhir.model.r4.String(value = "Organization/organization-001")
                    ),
