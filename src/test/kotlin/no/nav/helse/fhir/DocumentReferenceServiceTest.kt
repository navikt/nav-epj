...
class DocumentReferenceServiceTest {
    ...
    val documentReference1 =
        DocumentReference(
            ...
            author =
                listOf(Reference(reference = FhirString(value = "Practitioner/practitioner-001"))),
            content =
                listOf(
            ...
            context =
                DocumentReference.Context(
                    encounter =
                        listOf(Reference(reference = FhirString(value = "Encounter/encounter-001")))
                ),
        )
    ...
    val documentReference2 =
        DocumentReference(
            ...
            author =
                listOf(Reference(reference = FhirString(value = "Practitioner/practitioner-002"))),
            content =
                listOf(
                    DocumentReference.Content(
                        attachment =
            ...
            context =
                DocumentReference.Context(
                    encounter =
                        listOf(Reference(reference = FhirString(value = "Encounter/encounter-002")))
                ),
        )
    ...
    val documentReference3 =
        DocumentReference(
            ...
            context =
                DocumentReference.Context(
                    encounter =
                        listOf(Reference(reference = FhirString(value = "Encounter/encounter-003")))
                ),
        )
    ...
    fun `create document reference successfully`() {
        ...
        val newDocumentReference =
            DocumentReference(
                ...
                author =
                    listOf(
                        Reference(reference = FhirString(value = "Practitioner/practitioner-001"))
                    ),
                content =
                    listOf(
                        DocumentReference.Content(
                ...
                context =
                    DocumentReference.Context(
                        encounter =
                            listOf(
                                Reference(reference = FhirString(value = "Encounter/encounter-001"))
                            )
                    ),
            )
